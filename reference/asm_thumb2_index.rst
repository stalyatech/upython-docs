...
the :ref:`tutorial <stalya_tutorial_assembler>`. For a detailed description of the instruction set consult the
...
-  :ref:`Assembler Tutorial <stalya_tutorial_assembler>`
-  `Wiki hints and tips
