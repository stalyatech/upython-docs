...
To set the volume, define the following function::
    ...
    import sty
    def volume(val):
        sty.I2C(1, sty.I2C.MASTER).mem_write(val, 46, 0)
...
on your stalya (either on the flash or the SD card in the top-level directory).  You will need an
