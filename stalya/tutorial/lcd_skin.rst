...
At the end of the video, it shows you how to correctly connect the LCD skin to the stalya.
...
Make sure the LCD skin is attached to the stalya as pictured at the top of this page. ::
...
this script to your stalya (either flash or SD card, in the top
directory or ``lib/`` directory) and then try::

    >>> import sty
    >>> import mpr121
    >>> m = mpr121.MPR121(sty.I2C(1, sty.I2C.MASTER))
    >>> for i in range(100):
...
initialise the I2C bus using::
    ...
    >>> m = mpr121.MPR121(sty.I2C(2, sty.I2C.MASTER))
