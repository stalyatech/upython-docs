...
We can create 2 timers and run them independently::
    ...
    >>> tim4 = sty.Timer(4, freq=10)
    >>> tim7 = sty.Timer(7, freq=20)
    >>> tim4.callback(lambda t: sty.LED(1).toggle())
...
We set up timer 2 as follows::
    ...
    >>> micros = sty.Timer(2, prescaler=83, period=0x3fffffff)
