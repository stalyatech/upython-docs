...
The display can be plugged directly into a stalya (all stalya versions
are supported).  You plug the display onto the top of the stalya either
in the X or Y positions.  The display should cover half of the stalya.
...
stalya firmware (see `here <http://micropython.org/download>`__).  You
...
LCD.  This test program is included in recent versions of the stalya firmware
...
to monitor the output of any UART, not just from the stalya.  All that is needed
