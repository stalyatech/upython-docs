...
.. class:: sty.CAN(bus, ...)
   ...
   The physical pins of the CAN busses are:
     ...
     - ``CAN(1)`` is on ``CAN``: ``(RX, TX) = (CAN_RXD, CAN_TXD) = (PD0, PD1)``
...
.. method:: CAN.init(mode, extframe=False, prescaler=100, *, sjw=1, bs1=6, bs2=8, auto_restart=False)
   ...
   Initialise the CAN bus with the given parameters:
     ...
     - *prescaler* is used to set the duration of 1 time quanta; the time quanta
       will be the input clock (PCLK1, see :meth:`sty.freq()`) divided by the prescaler
   ...
   see :meth:`sty.freq()` to determine PCLK1.
