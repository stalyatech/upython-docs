:mod:`sty` --- functions related to the board
=============================================

.. module:: sty
   :synopsis: functions related to the board

The ``sty`` module contains specific functions related to the board.
...
.. function:: millis()
   ...
   Note that if :meth:`sty.stop()` is issued the hardware counter supporting this
   function will pause for the duration of the "sleeping" state. This
   will affect the outcome of :meth:`sty.elapsed_millis()`.
...
.. function:: micros()
   ...
   Note that if :meth:`sty.stop()` is issued the hardware counter supporting this
   function will pause for the duration of the "sleeping" state. This
   will affect the outcome of :meth:`sty.elapsed_micros()`.
...
.. function:: elapsed_millis(start)
   ...
   Example::
       ...
       start = sty.millis()
       while sty.elapsed_millis(start) < 1000:
...
.. function:: elapsed_micros(start)
   ...
   Example::
       ...
       start = sty.micros()
       while sty.elapsed_micros(start) < 1000:
           # Perform some operation
           pass
...
.. function:: have_cdc()
   ...
   .. note:: This function is deprecated.  Use sty.USB_VCP().isconnected() instead.
...
.. function:: hid((buttons, x, y, z))
   ...
   .. note:: This function is deprecated.  Use :meth:`sty.USB_HID.send()` instead.
...
.. function:: usb_mode([modestr], port=-1, vid=0xf055, pid=-1, msc=(), hid=sty.hid_mouse, high_speed=False)
   ...
   mouse.  There is also a ``sty.hid_keyboard`` constant, which is an
