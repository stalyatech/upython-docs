...
Example usage::
    ...
    s1 = sty.Servo(1)   # create a servo object on position QP1
    s2 = sty.Servo(2)   # create a servo object on position QP2
...
.. class:: sty.Servo(id)
   ...
   Create a servo object.  ``id`` is 1-4, and corresponds to pins QP1 through QP4.
