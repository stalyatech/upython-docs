...
Example usage to toggle an LED at a fixed frequency::
    ...
    tim = sty.Timer(4)              # create a timer object using timer 4
...
Example using named function for the callback::
    ...
    tim = sty.Timer(4, freq=1)      # create a timer object using timer 4 - trigger at 1Hz
    tim.callback(tick)              # set the callback to our tick function

Further examples::

    tim = sty.Timer(4, freq=100)    # freq in Hz
    tim = sty.Timer(4, prescaler=0, period=99)
...
.. method:: Timer.init(*, freq, prescaler, period, mode=Timer.UP, div=1, callback=None, deadtime=0)
   ...
   Keyword arguments:
     ...
     - ``prescaler`` [0-0xffff] - specifies the value to be loaded into the
       ...
       have a clock source of 84 MHz (sty.freq()[2] \* 2), and Timers 1, and 8-11
       have a clock source of 168 MHz (sty.freq()[3] \* 2).
...
.. method:: Timer.channel(channel, mode, ...)
   ...
   PWM Example::
       ...
       timer = sty.Timer(2, freq=1000)
       ch2 = timer.channel(2, sty.Timer.PWM, pin=sty.Pin.board.X2, pulse_width=8000)
       ch3 = timer.channel(3, sty.Timer.PWM, pin=sty.Pin.board.X3, pulse_width=16000)
